  ...
  return (
    <>
      <div className="min-h-screen py-10">
        <section className="container mx-auto flex flex-col justify-center items-center px-5 py-10">
          <div className="flex flex-col items-center justify-center gap-3 md:flex-row">
            <div className="flex flex-col justify-center items-center gap-5 px-3 py-5 md:items-start md:flex-1">
              ...
              <h2 className=" text-white md:text-2xl lg:text-4xl text-center md:text-start font-['Medium']">
