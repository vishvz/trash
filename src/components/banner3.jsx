                ...
                <section className="container mx-auto flex flex-col justify-center items-center md:pb-40 pb-20">
                    <div className="flex flex-col items-center justify-center gap-3 md:flex-row">
                        <div className="flex flex-col justify-center items-center gap-5 px-3 py-5 md:items-start md:flex-1">
                            ...
                            <h2 className=" text-white md:text-2xl lg:text-4xl text-center md:text-start">Get In Touch With Zetbet  CUSTOMER CARE For Any Queries, Emergencies, Feedbacks or Complaints. We Are Here To Help You 24/7 With Our Online Services.
                                24 hours service</h2>
                ...
                <section className="container mx-auto flex flex-col justify-center items-center md:pb-40 pb-20">
                    <div className="flex flex-col items-center justify-center gap-3 md:flex-row">
                        ...
                        <div className="flex flex-col justify-center items-center gap-5 px-3 py-5 md:items-start md:flex-1">
                            ...
                            <h2 className=" text-white md:text-2xl lg:text-4xl text-center md:text-start">With Our Step-By-Step Guide For Beginners,
                                Get Started Playing. Start Learning Now.. 24/7 ACTIVE.</h2>
                            <h2 className=" text-white md:text-xl lg:text-3xl text-center md:text-start">
