...
const Insta = () => {
  return (
    <section className="relative container mx-auto min-h-screen w-full mb-16 md:mb-28 lg:mb-60">
      <img
        src={instaBack}
        alt=""
      ...
      <div className="flex justify-center lg:mb-80">
        <div className="flex flex-col gap-3 sm:gap-6 lg:gap-10 pb-36 items-center">
          ...
          <img
            ...
            className="max-w-md -bottom-20 md:max-w-3xl absolute lg:-bottom-60 "
            alt=""
          />
        </div>
      </div>
