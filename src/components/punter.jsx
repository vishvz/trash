...
function Punter() {
  return (
    <section className="relative mx-auto h-auto">
      <div className="flex flex-col md:flex-row justify-between items-center gap-3">
        ...
        <div className="text-center">
          ...
          <h2 className=" text-white md:text-xl lg:text-2xl md:pb-10 pb-5">
            We Deals With All Branded Sites, And Present The Fastest Withdrawal
            Service.
          </h2>
          <h2 className=" text-white md:text-xl lg:text-3xl md:pb-5 pb-3">
